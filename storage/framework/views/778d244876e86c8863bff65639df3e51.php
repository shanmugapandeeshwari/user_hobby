...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
            <input type="checkbox" name="hobbies[]" value="<?php echo e($hobby->id); ?>" id="<?php echo e($hobby->id); ?>">
             <label for="<?php echo e($hobby->id); ?>"><?php echo e($hobby->hobbie_name); ?></label>
    </div>
...
</html><?php /**PATH G:\laravel\user_hobby\resources\views/user.blade.php ENDPATH**/ ?>